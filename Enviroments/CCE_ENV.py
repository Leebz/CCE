...
class Env(object):
    def __init__(self, seed=0,
        ...
        self.edge_capacity = egde_capacity
    ...
    def reset(self):
        ...
        # State: remain capacity in edge, task size, task length, public cloud price.
        self.state = [self.remain_capacity, task_info[0], task_info[1], cloud_price]
